<?php if(Session::has('message')): ?>
    ...
    <div id="dynamic_display" class="alert-message media <?php echo e(Session::get('class')); ?>">
        <div class="media-left "><i class="material-icons">check_circle</i><!--i class="material-icons">swap_vertical_circle</i--></div>
        <div class="media-body" id="status_msg"><?php echo e(Session::get('message')); ?></div>
...
<?php if(Session::has('errors')): ?>
    <div id="error_message_display" class="alert-message media active">
        ...
        <div class="media-body" id="error_status_msg"><?php echo app('translator')->getFromJson('general.failure'); ?></div>
