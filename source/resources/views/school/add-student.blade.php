      ...
      <div class="row">
          <div class="scroll-main-wrapper2">
              <div class="col-md-12">
                ...
                <form id="addedit_user" role="form" @if(isset($userDetail)) action="{{ url(App::getLocale().'/'. generateUrlPrefix().'/students/'.$userDetail->id.'/edit') }}" @else action="{{ url(App::getLocale().'/'. generateUrlPrefix().'/students/add') }}" @endif  method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                          ...
                          <div class="col-lg-4 col-xs-12">
                              <div class="row">
                                  ...
                                  <div class="form-group col-xs-12 {{ $errors->has('schoolId') ? ' has-error' : '' }}">
                                      ...
                                      <select id="schoollist" class="selectpicker" name="schoolId[]" @if(!empty($userDetail) && ( $userDetail->userrole==2 ) ) multiple="multiple" @endif />
                                              ...
                                              @if($school->schoolName)
                                                  <option value="{{ $school->id }}"
                                                          @if(!empty($user_schools) && in_array($school->id, $user_schools ))
                                                            selected="selected"
                                                          @elseif(!empty(old('schoolId')[0]) && $school->id == old('schoolId')[0]))
                                                            selected="selected"
                      ...
                      <div class="row">
                          <div class="col-lg-12 col-xs-12">
                              <div class="form-group pull-right">
                                  ...
                                  <a class="btn btn-default btn-vdesk-light" href="{{ url(App::getLocale().'/'. generateUrlPrefix().'/students') }}">@lang('general.cancel')</a>
                              </div>
                          </div>
                      </div>
                  </div>
