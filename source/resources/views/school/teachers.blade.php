                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="aineisto" aria-labelledby="aineisto-tab">
                                <div class="material-tab">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="search-filter-main" id="adv-search">
                                                                <input type="text" id="global_search" class="form-control select2" placeholder="@lang('schooladmin.teacher_search_title')" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="materialtable">
                                        <table class="gridtable table-bordered" id="teachers_list" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <thead>
                                            <tr>
    ...
    <script>
        ...
        jQuery(function() {
           ...
           // jQuery(".select2").select2();
            var teacherlist = jQuery('#teachers_list').on( 'error.dt', function ( e, settings, techNote, message ) {
                console.log( 'An error has been reported by DataTables: ', message );
            } ).DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! generateLangugeUrl(App::getLocale(),url(generateUrlPrefix().'/teacher/teacherslist')) !!}',
                columns: [
