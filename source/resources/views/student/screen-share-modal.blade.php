    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="incomingScreenShareModalLabel"></span>@lang('student.incomingShareTitle')<span id="requestedByName"></h5>
            </div>
            <div class="modal-body">
                @lang('student.incomingShareMessage')
            </div>
            <div class="modal-footer">
                <div id="share_footer" style="display: none;">
