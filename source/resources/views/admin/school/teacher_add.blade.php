...
@else
    @section('title', __('adminuser.addteacher'))
@endif
@else
    @section('title', __('adminuser.addteacher'))
@endif
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-warning">
                        ...
                        @if(isset($userDetail))
                            <form id="addedit_user" role="form"
                                  action="{{ url('admin/schools/teachers/'.$userDetail->id.'/edit') }} " method="post" enctype="multipart/form-data">
                                @else
                                    <form id="addedit_user" role="form"
                                          action="{{ url('admin/schools/teachers/create') }} " method="post"
                                    ...
                                    <!-- /.box-header -->
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <a class="btn btn-default"
                                               href="{{ url('admin/schools/teachers') }}">@lang('general.cancel')</a>
                                        </div>
