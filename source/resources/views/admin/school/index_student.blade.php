...
@section("content")
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>
                @lang('adminuser.student_management')
                <small>List</small>
            </h1>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"> @lang('adminuser.student_management')</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
@section("page-js")
    ...
    <script>
        jQuery(function() {
            var studentlist = jQuery('#student_list').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! url('admin/schools/studentlist') !!}',
                columns: [
