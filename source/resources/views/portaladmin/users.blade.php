                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="aineisto" aria-labelledby="aineisto-tab">
                                <div class="material-tab">
                                    ...
                                    <div class="materialtable">
                                        <table class="gridtable table-bordered" id="users-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <thead>
                                            <tr>
...
@section("scripts")
    ...
    <script>
        ...
        jQuery(function() {
            var usertable = jQuery('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: usersUrl+'userslist',
                columns: [
            ...
            usertable.on( 'draw', function () {
                ...
                jQuery("#btnYes").unbind().click(function(e) {
                    ...
                    showloader();
                    jQuery.ajax({
                        url: usersUrl+"users/" + userId +'/destroy',
                        type: 'GET',
                        data: userId,
                ...
                jQuery(".restore-adminusers").on('click', function(e) {
                    ...
                    jQuery( ".alert-danger").remove();
                    jQuery.ajax({
                        url: usersUrl+"users/" + userId +'/restore',
                        type: 'GET',
                        data: userId,
                        success: function( data ) {
                            if ( data.status == true ) {
